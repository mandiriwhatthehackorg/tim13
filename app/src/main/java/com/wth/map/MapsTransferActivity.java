...
public class MapsTransferActivity extends FragmentActivity implements OnMapReadyCallback {
...
//        Toast.makeText(getApplicationContext(), "WooooooooooooOW", Toast.LENGTH_SHORT).show();
        final ProgressDialog dialog = ProgressDialog.show(MapsTransferActivity.this, "",
                "Mencari kurir...", true);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                dialog.dismiss();
                new AlertDialog.Builder(MapsTransferActivity.this)
                        .setTitle("Konfirmasi Kurir")
                        .setMessage("Kurir atas nama Andika akan segera sampai")

                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(MapsTransferActivity.this, "Pembayaran berhasil dilakukan", Toast.LENGTH_SHORT).show();
                            }
                        })
